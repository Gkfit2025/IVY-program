...
export const opportunitiesDatabase: Opportunity[] = [
  ...
  },
  {
    ...
    hostName: "Apollo Health Foundation",
    hostImage: "indian male doctor profile photo",
    image: "medical interns working in hospital setting",
    rating: 4.7,
    reviews: 32,
    price: "₹3,500/week",
    ...
    verified: true,
    description:
      "Gain hands-on medical experience in hospitals and clinics while supporting healthcare delivery in underserved communities.",
    requirements: ["Medical/nursing student", "Basic medical knowledge", "English proficiency"],
    included: ["Shared accommodation", "Cafeteria meals", "Medical training", "Internship certificate"],
  },
  {
    id: 5,
    ...
    type: "both",
    category: "Healthcare & Medical",
    hostName: "Rural Health Initiative",
    hostImage: "indian female nurse profile photo",
    image: "healthcare volunteers in rural clinic",
    rating: 4.6,
    reviews: 28,
    price: "₹2,200/week",
    ...
    verified: true,
    description:
      "Support rural healthcare initiatives through medical camps, health education, and community outreach programs.",
    requirements: ["Healthcare background preferred", "Adaptability", "Team player"],
    included: ["Guest house accommodation", "Traditional meals", "Transport", "Health training"],
  },
]
