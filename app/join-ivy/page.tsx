              ...
              <Card className="group hover:shadow-xl transition-all duration-300 border-gray-800 bg-gray-900">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full bg-[#F0661F] hover:bg-[#F0661F]/90 text-white">
                    <Link href="/apply?program=internship" className="block w-full">
                      Apply Now
                    </Link>
                  </Button>
                </CardContent>
              ...
              <Card className="group hover:shadow-xl transition-all duration-300 border-gray-800 bg-gray-900">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full bg-green-600 hover:bg-green-700 text-white">
                    <Link href="/apply?program=volunteer" className="block w-full">
                      Apply Now
                    </Link>
                  </Button>
                </CardContent>
              ...
              <Card className="group hover:shadow-xl transition-all duration-300 border-gray-800 bg-gray-900 md:col-span-2 lg:col-span-1">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white">
                    <Link href="/apply?program=explore-all" className="block w-full">
                      Apply Now
                    </Link>
                  </Button>
                </CardContent>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#F0661F] text-white">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" className="bg-white hover:bg-white/90 text-[#F0661F]">
                <Link href="/apply?program=internship">Start with Internship</Link>
              </Button>
              <Button
                size="lg"
                variant="outline"
              ...
              >
                <Link href="/apply?program=volunteer">Find Volunteer Work</Link>
              </Button>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <Link href="/apply?program=volunteer" className="block hover:text-white transition-colors">
                    Volunteering
                  </Link>
                  <Link href="/apply?program=internship" className="block hover:text-white transition-colors">
                    Internship
                  </Link>
                  <Link href="/apply?program=explore-all" className="block hover:text-white transition-colors">
                    All Programs
                  </Link>
                </div>
              </div>
