          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-8">
              ...
              <Button
                ...
                onMouseOut={(e) => {
                  ;(e.target as HTMLButtonElement).style.background = "#F76005";
                  ;(e.target as HTMLButtonElement).style.color = "#080707";
                }}
              >
                Join IVY
              </Button>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input placeholder="Enter your nationality" className="h-12" />
                    </div>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input placeholder="Enter cardholder name" className="h-12" />
                    </div>
                    <div>
